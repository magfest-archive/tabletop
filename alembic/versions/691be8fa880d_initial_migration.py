...
def upgrade():
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('tournament_id', postgresql.UUID(), nullable=False),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('entrant_id', postgresql.UUID(), nullable=False),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('entrant_id', postgresql.UUID(), nullable=True),
    sa.Column('sid', sa.Unicode(), server_default='', nullable=False),
    sa.Column('when', sa.DateTime(), nullable=False),
    sa.Column('text', sa.Unicode(), server_default='', nullable=False),
